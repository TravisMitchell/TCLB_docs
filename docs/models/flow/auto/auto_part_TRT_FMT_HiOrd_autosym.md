...
## Description
auto_part_TRT_FMT_HiOrd_autosym


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/auto_part_TRT_FMT_HiOrd_autosym/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/auto_part_TRT_FMT_HiOrd_autosym/Dynamics.R)
