...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/auto_part_FMT_HiOrd/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/auto_part_FMT_HiOrd/Dynamics.R)
