...
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/d2q9_pf_velocity_RT_autosym/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/d2q9_pf_velocity_RT_autosym/Dynamics.R)
...
| --- | --- | --- | --- |
|PhaseInit|Init_phase|_none_|PhaseF, PhaseOld|
...
|BaseIter|calcHydroIter|g[0], g[1], g[2], g[3], g[4], g[5], g[6], g[7], g[8], h[0], h[1], h[2], h[3], h[4], h[5], h[6], h[7], h[8], U, V|g[0], g[1], g[2], g[3], g[4], g[5], g[6], g[7], g[8], h[0], h[1], h[2], h[3], h[4], h[5], h[6], h[7], h[8], U, V|
|PhaseIter|calcPhaseFIter|h[0], h[1], h[2], h[3], h[4], h[5], h[6], h[7], h[8]|PhaseF, PhaseOld|
|WallIter|calcWallPhaseIter|nw_x, nw_y|PhaseF, PhaseOld|
