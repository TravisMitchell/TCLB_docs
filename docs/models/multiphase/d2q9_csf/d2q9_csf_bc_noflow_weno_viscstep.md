...
## Description
d2q9_csf_bc_noflow_weno_viscstep


## Details
[Model description files](Model description) files for this model:
[Dynamics.c](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/d2q9_csf_bc_noflow_weno_viscstep/Dynamics.c.Rt)
[Dynamics.R](https://github.com/llaniewski/TCLB/blob/(HEAD detached at ba89bcc)/src/d2q9_csf_bc_noflow_weno_viscstep/Dynamics.R)
